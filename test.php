...
<?php
	...
	#接收使用者傳入權重,$all
$all=array("$_POST[user_1]","$_POST[user_2]","$_POST[user_3]","$_POST[user_4]","$_POST[user_5]","$_POST[user_6]","$_POST[user_7]","$_POST[user_8]","$_POST[user_9]","$_POST[user_10]","$_POST[user_11]","$_POST[user_12]");
...
$all_after=array();
	...
	//$bicycle:每台車的分項分數
$bicycle=array(0=>array(5,10,5,4,4,4,3,6,8,10,4,4),1=>array(5,5,5,5,6,2,4,6,7,10,4,7),2=>array(3,5,5,3,4,2,2,6,9,10,4,5),3=>array(4,2,5,2,3,2,2,9,8,10,4,6),4=>array(4,10,5,4,4,6,1,6,9,10,4,4),5=>array(3,10,5,4,4,6,1,5,9,10,4,5),6=>array(7,5,10,7,5,6,4,4,5,10,4,3),7=>array(7,2,5,8,6,6,4,5,7,10,4,2),8=>array(5,2,10,4,5,6,4,5,5,10,4,3),9=>array(5,10,5,4,4,6,4,3,7,10,4,3),10=>array(4,5,5,3,3,2,1,6,10,10,4,5),11=>array(7,10,10,8,8,6,9,2,5,10,2,3),12=>array(7,8,10,9,5,6,9,5,6,10,2,3),13=>array(6,10,5,4,5,2,4,5,6,10,4,7),14=>array(6,8,0,9,5,2,4,5,5,10,4,5),15=>array(6,10,10,9,8,2,9,8,6,10,2,4),16=>array(7,8,5,8,6,6,9,6,2,10,6,4),17=>array(9,10,5,7,6,2,9,3,3,10,2,1),18=>array(8,5,10,10,9,8,10,0,4,5,0,1));
...
$winner=array();
	...
	#判別使用者輸入車種,計算前三名
if($style=='motorcycle'){
	$motorcycle=array("13"=>"$who[13]","14"=>"$who[14]","15"=>"$who[15]","16"=>"$who[16]","17"=>"$who[17]");
	arsort($motorcycle);	
	$winner[0] = array_search(max($motorcycle),$motorcycle)+1;
	$motorcycle[$winner[0]-1]=-1;
	$winner[1] = array_search(max($motorcycle),$motorcycle)+1;
	$motorcycle[$winner[1]-1]=-1;
	$winner[2] = array_search(max($motorcycle),$motorcycle)+1;
	$motorcycle[$winner[2]-1]=-1;
}
elseif($style=='scooter'){
	unset($who[13]);
	unset($who[14]);
	unset($who[15]);
	unset($who[16]);
