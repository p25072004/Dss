...
<?php include 'connect.php';?>
    ...
    <nav id="sidebar-wrapper">
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-brand">
                <a href="#top" onclick=$("#menu-close").click();>兩輪代步車種</a>
            </li>
            <li>
                <a href="index.html" onclick=$("#menu-close").click();>回到首頁</a>
            </li>
            <li>
                <a href="#Category_list" onclick=$("#menu-close").click();>一般機車</a>
            </li>
            <li>
                <a href="#Category_list2" onclick=$("#menu-close").click();>電動車</a>
            </li>
            <li>
    ...
    <header id="top" class="header">
        <div class="text-vertical-center">
            ...
            <br>
            <a href="#Category_list" class="btn btn-dark btn-lg">一般機車</a>
            <a href="#Category_list2" class="btn btn-dark btn-lg">電動車</a>
        </div>
    </header>
...
function createMarker(place) {
  ...
  <body>
    <div id="map"></div>
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBgur6-U3sh-gBTPuY2YOCWDEeCLh-1jak&signed_in=true&libraries=places&callback=initMap" async defer></script>
  </body>
			</div>
            ...
            <div class="row">
                <div class="col-lg-10 col-lg-offset-1 text-center">
                    ...
                    <ul class="list-unstyled">
                        <li><i class="fa fa-phone fa-fw"></i> (03) 463-8800</li>
